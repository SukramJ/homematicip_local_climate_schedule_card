    ...
    `}_handleEntitySelection(t){const e=t.target.value;e&&e!==this._getActiveEntityId()&&(this._activeEntityId=e,this._editingWeekday=void 0,this._editingBlocks=void 0,this._copiedSchedule=void 0,this._validationWarnings=[],this._parsedScheduleCache=new WeakMap,this._updateFromEntity())}_startSlotEdit(t){if(!this._editingBlocks||t<0||t>=this._editingBlocks.length)return;const e=this._editingBlocks[t];this._editingSlotIndex=t,this._editingSlotData={startTime:e.startTime,endTime:e.endTime,temperature:e.temperature}}_startSlotEditFromDisplay(t,e){if(!this._editingBlocks)return;const i=e[t],s=this._editingBlocks.findIndex(t=>t.startMinutes===i.startMinutes&&t.endMinutes===i.endMinutes&&t.temperature===i.temperature);-1!==s&&this._startSlotEdit(s)}_cancelSlotEdit(){this._editingSlotIndex=void 0,this._editingSlotData=void 0}_saveSlotEdit(){if(void 0===this._editingSlotIndex||!this._editingSlotData||!this._editingBlocks||void 0===this._editingBaseTemperature)return;const t=this._editingSlotIndex,{startTime:e,endTime:i,temperature:s}=this._editingSlotData,o={startTime:e,startMinutes:St(e),endTime:i,endMinutes:St(i),temperature:s,slot:t+1},r=this._editingBlocks.filter((e,i)=>i!==t),n=function(t,e){const i=[],s=e.startMinutes,o=e.endMinutes,r=[...t].sort((t,e)=>t.startMinutes-e.startMinutes);for(const t of r){const e=t.startMinutes,r=t.endMinutes;r<=s||e>=o?i.push(t):(e<s&&i.push({...t,endTime:wt(s),endMinutes:s,slot:i.length+1}),r>o&&i.push({...t,startTime:wt(o),startMinutes:o,slot:i.length+1}))}i.push({...e,slot:i.length+1});const n=i.sort((t,e)=>t.startMinutes-e.startMinutes);return Ct(n)}(r,o),a=Ct(Ut(n));this._saveHistoryState(),this._editingBlocks=a,this._editingSlotIndex=void 0,this._editingSlotData=void 0,this._updateValidationWarnings()}_addNewSlot(){if(!this._editingBlocks||void 0===this._editingBaseTemperature)return;if(this._editingBlocks.length>=12)return;let t=0,e=60;if(this._editingBlocks.length>0){const i=Ut(this._editingBlocks),s=i[i.length-1];if(s.endMinutes<1440)t=s.endMinutes,e=Math.min(t+60,1440);else{let s=!1;for(let o=0;o<i.length;o++){const r=0===o?0:i[o-1].endMinutes;if(i[o].startMinutes>r){t=r,e=i[o].startMinutes,s=!0;break}}if(!s)return}}const i=Math.min(this._editingBaseTemperature+2,this._maxTemp),s={startTime:wt(t),startMinutes:t,endTime:wt(e),endMinutes:e,temperature:i,slot:this._editingBlocks.length+1};this._saveHistoryState();const o=Ut([...this._editingBlocks,s]);this._editingBlocks=o;const r=o.findIndex(i=>i.startMinutes===t&&i.endMinutes===e);r>=0&&this._startSlotEdit(r),this._updateValidationWarnings()}_renderEditor(){if(!this._editingWeekday||!this._editingBlocks)return V``;const t=void 0!==this._editingBaseTemperature?Pt(this._editingBlocks,this._editingBaseTemperature):this._editingBlocks;return V`
      <div class="editor">
        ...
        <div class="editor-content">
          ...
          ${t.map((e,i)=>{const s=this._editingBlocks.findIndex(t=>t.startMinutes===e.startMinutes&&t.endMinutes===e.endMinutes&&t.temperature===e.temperature),o=!(-1!==s);return void 0!==this._editingSlotIndex&&this._editingSlotIndex===s&&void 0!==this._editingSlotData&&this._editingSlotData?V`
