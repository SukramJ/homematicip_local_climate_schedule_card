      ...
      <ha-card>
        ...
        <div class="header-controls">
          ...
          ${this._config.show_profile_selector&&this._availableProfiles.length>0?j`
              ...
              `:""}
          ${i?j`<span class="api-version-badge">${this._getScheduleApiVersion(i)}</span>`:""}
          <button
            class="export-btn"
    ...
    `:j`
      ...
      <div class="schedule-container">
        ...
        <div class="schedule-content">
          ${yt(wt,t=>`${t}-${this._currentProfile}-${this._lastScheduleDataHash}`,t=>{const e=this._getParsedBlocks(t),i=this._getBaseTemperature(t),s=Ut(e,i);return j`
                <div
