    ...
    `:j`
      ...
      <div class="schedule-container">
        ...
        <div class="schedule-content">
          ${yt(wt,t=>`${t}-${this._currentProfile}-${this._lastScheduleDataHash}`,t=>{const e=this._getParsedBlocks(t),i=this._getBaseTemperature(t),s=Wt(e,i);return j`
                <div
