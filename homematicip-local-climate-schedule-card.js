    ...
    `:j`
      ...
      <div class="schedule-container">
        ...
        <div class="schedule-content">
          ${yt(wt,t=>t,t=>{const e=this._getParsedBlocks(t),i=this._getBaseTemperature(t),s=Wt(e,i);return j`
                <div
                  class="time-blocks ${this._config?.editable?"editable":""}"
                  @click=${()=>this._config?.editable&&this._handleWeekdayClick(t)}
                >
                  ${yt(s,t=>`${t.slot}-${t.startMinutes}`,(o,r)=>{const n=this._isBlockActive(t,o),a=o.temperature===i&&!e.some(t=>t.startMinutes===o.startMinutes&&t.endMinutes===o.endMinutes);let l;if(a)l="background-color: var(--secondary-background-color, #e0e0e0);";else if(this._config?.show_gradient){l=`background: ${function(t,e,i){const s=Pt(t);return null===e&&null===i?s:null!==e&&null===i?`linear-gradient(to bottom, ${Pt(e)}, ${s})`:null===e&&null!==i?`linear-gradient(to bottom, ${s}, ${Pt(i)})`:`linear-gradient(to bottom, ${Pt(e)}, ${s} 50%, ${Pt(i)})`}(o.temperature,r>0?s[r-1].temperature:null,r<s.length-1?s[r+1].temperature:null)};`}else l=`background-color: ${Pt(o.temperature)};`;return j`
                        <div
        ...
        <div class="editor-content">
          ...
          ${t.map((e,i)=>{const s=this._editingBlocks.findIndex(t=>t.startMinutes===e.startMinutes&&t.endMinutes===e.endMinutes),o=!(-1!==s);return void 0!==this._editingSlotIndex&&this._editingSlotIndex===s&&void 0!==this._editingSlotData&&this._editingSlotData?j`
              ...
              <div class="time-block-editor ${o?"base-temp-slot":""}">
                ...
                <div
                  class="color-indicator"
                  style="background-color: ${Pt(e.temperature)}"
                ></div>
              </div>
            `})}
